        ...
        <div class="row">
            ...
            <div class="col-sm-10 account-info">
                ...
                <div id="shipping-info" class="account-info-content">
                    ...
                    <p>Address: <span>{{ $userData->address_1 }}</span></p>
                    <p>Address 2: <span>{{ $userData->address_2 }}</span></p>
                    <p>State / Province: <span>{{ $userData->state_province }}</span></p>
                    <p>City: <span>{{ $userData->city }}</span></p>
                    <p>ZIP Code: <span>{{ $userData->zip_postal }}</span></p><p>Country: <span>{{ $userData->country }}</span></p>
                ...
                <div id="my-reviews" class="account-info-content">
                    <h4>My Reviews <span class="pull-right"></h4>
