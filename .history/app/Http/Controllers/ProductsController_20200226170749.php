...
//      $products = DB::table('products')->get();
    ...
    {
        $products = Product::paginate(9); // orig
...
//        ->get();
    ...
    {
        $products = Product::where('productType_id', 1)->paginate(6);
        return view("swimwear", compact("products", "image"));
    }

    //category for cover ups
    public function coverUpProducts()
    {
        $products = Product::where('productType_id', 2)->paginate(6);
        return view("coverUps", compact("products", "image"));
    }

    //category for accessories
    public function accessoryProducts()
    {
        $products = Product::where('productType_id', 3)->paginate(6);
        return view("accessories", compact("products", "image"));
    }
    ...
    //swimwear filters
        //category for swimwear
            ...
            public function multiwayProducts()
            {
                ...
                return view("swimwear", compact("products")); //the 2nd priameter "image" was deleted cause it was undefined
            }
...
//show related products
    public function showRelatedProducts($id)
    {
        ...
        ->where('producType_id', $relatedProducts->id)->get();

        echo"<h1>$relatedProducts</h1>";
    }
