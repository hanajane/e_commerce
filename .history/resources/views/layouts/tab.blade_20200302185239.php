					...
					<div class="col-sm searchBig">
						<div class="search_box pull-right">
							<form action="search" method="GET">
								{{-- <input type="text" name="searchText" placeholder="Search"/><a href=""><img src="../images/home/searchicon.png" alt=""> --}}
									<div class="wrap">
										<div class="search">
											<input type="text" name="searchText" class="searchTerm" placeholder="What are you looking for?"  alt="seach bar">
